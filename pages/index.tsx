...
export default function Home() {
  return (
    <YStack f={1} ai="center" jc="center" h="100vh" p="$4" gap="$4" alignItems="center">
      ...
      <YStack w="90%" maxWidth={700} p="$4" borderRadius="$4">
      ...
      <YStack w="90%" maxWidth={600} p="$4" borderRadius="$4">
